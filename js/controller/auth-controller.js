...
const responseFailValidation = (res, message) =>
  res.status(400).json({
    success: false,
    message: message,
  });
...
const register = (req, res) => {
  if (
    ...
    responseFailValidation(res, "Email/Username/Password Wajib Diisi");
  }
...
const login = (req, res) => {
  if (req.body.email == null || req.body.password == null) {
    responseFailValidation(res, "Email/Password Wajib Diisi");
  }
